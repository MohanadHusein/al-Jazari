...
class MotorControl:
    def __init__(self):
        ...
        self.pid_timer_interval = 25 # millisecond
        ...
        self.right_linear_velocity_pid = pid.PIDController(kp=5.8, ki=3.7, kd=0.75)
    ...
    def test_run(self):
        ...
        for speed in [0, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0]:
    ...
    def reset_encoders_counter(self, timer):
        ...
        print(f'Right encoder counter {self.right_linear_velocity} , '
              ...
              f' left pwm from PID: {self.left_pwm_from_pid}')
    ...
    def run_pid(self, timer):
        ...
        right_output_pwm = round(right_shifted_pid_pwm / 10 * 850) # mapping pid output to 0-850 pwm
        right_output_pwm = max(min(right_output_pwm, 850), 0) #capping the values at 850 pwm
